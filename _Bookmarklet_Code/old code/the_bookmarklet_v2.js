javascript: (function() {
    ...
    window.open('http://localhost/mypages/udemy_app_v3/_Bookmarklet_Code/new_scraper_json_dom.php?name=' + encodeURIComponent(x) + '');
    var y = JSON.stringify(big_2);
    console.log(y.length);
    window.open('http://localhost/mypages/udemy_app_v3/_Bookmarklet_Code/new_scraper_json_dom.php?name=' + encodeURIComponent(y) + '');
})()